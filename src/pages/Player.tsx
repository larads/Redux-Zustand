      ...
      <div className="flex w-[1100px] flex-col gap-6">
        ...
        <main className="relative flex overflow-hidden rounded-lg border border-zinc-800 bg-zinc-900 shadow pr-80">
          <div className="w-full bg-zinc-950 aspect-video">
            ...
            <Module moduleIndex={0} title="Agatha Desde Sempre Disney+" amountOfLessons={3} />
            <Module moduleIndex={1} title="Agatha Desde Sempre Disney+" amountOfLessons={3} />
            <Module moduleIndex={2} title="Agatha Desde Sempre Disney+" amountOfLessons={3} />
          </aside>
        </main>
      </div>
    </div>
